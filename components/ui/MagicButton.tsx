...
function MagicButton() {
  return (
    <button className="relative inline-flex h-12 overflow-hidden rounded-2xl p-[1px] focus:outline-none items-center focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
      ...
      <span className="inline-flex h-full w-full gap-2 cursor-pointer items-center justify-center rounded-2xl bg-slate-950 px-4 py-1 text-sm font-medium text-white backdrop-blur-3xl">
        See my work
        <FaLocationArrow /> 
      </span>
    </button>
